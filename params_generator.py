...
class ParamsGenerator:
    ...
    def __create_list(element : Any, new_val : Any):
        ...
        if type(current_element) == set:
            ...
            if len(current_element) == 2:
                ...
                return [el for el in list(np.arange(current_element[0], current_element[1]+step, step))]
        else:
    ...
    def __choice_to_dict(self, choice: list) -> dict:
        ...
        'regularizer_params': {'l1': self.table.loc[18][self.k2][choice[18]],
    ...
    def __init__(self, model_name : str,
                 ...
                 **kwargs):
        self.__init_table()
        self.table.loc[15][self.k2] = self.__create_list(self.table.loc[15][self.k2], loss_function)
        self.table.loc[16][self.k2] = self.__create_list(self.table.loc[16][self.k2], model_name)
        self.table.loc[2][self.k2] = self.__create_list(self.table.loc[2][self.k2], recurrent_type)
